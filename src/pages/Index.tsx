...
const Index = () => {
  ...
  return <SidebarProvider>
      <div className="h-screen min-h-0 flex w-full p-4 gap-4 pb-20 overflow-hidden orientation-stable landscape:p-2 landscape:gap-2 landscape:pb-4">
        <AppSidebar onNewApplication={() => setIsModalOpen(true)} />
        <div className="flex-1 flex flex-col gap-3 min-h-0 overflow-hidden landscape:gap-2">
